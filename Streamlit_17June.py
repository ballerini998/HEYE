...
UI = {
    "it": {
        ...
        "subtitle": "Cruscotto territoriale su demografia, lavoro giovanile, migrazioni e transizione alla vita adulta",
        "menu": "Menu",
        "go_to": "Vai a",
        ...
        "schema_intro": "Questa versione mostra solo gli indicatori costruibili con i dataset gia preparati: popolazione attuale, proiezioni, disoccupazione, inattivita e migrazioni.",
        ...
        "data_quality_text": "Per i tassi non vengono creati totali Maschi/Femmine senza denominatori. Per le migrazioni, invece, i totali per sesso, cittadinanza e classe 0-39 sono calcolati per somma perche i dati sono conteggi.",
        "status_ok": "OK",
    ...
    "en": {
        "language": "Language",
        "title": "HEYE-DEEP Dashboard",
        "subtitle": "Territorial dashboard on demography, youth labour market, migration and transition to adulthood",
        "menu": "Menu",
        "go_to": "Go to",
        ...
        "schema_intro": "This version shows only indicators that can be built from the datasets already prepared: current population, projections, unemployment, inactivity and migration.",
        ...
        "data_quality_text": "For rates, Male/Female totals are not computed without denominators. For migration, totals by sex, citizenship and 0-39 age group are computed by summing counts.",
        "status_ok": "OK",
...
def rows_for_indicator(ind, population_df, projection_df, unemployment_df, inactivity_df, migration_df):
    indicator_id = ind["indicator_id"]
...
def render_indicator(ind, population_df, projection_df, unemployment_df, inactivity_df, migration_df, lang):
    ...
    df = rows_for_indicator(ind, population_df, projection_df, unemployment_df, inactivity_df, migration_df)
    if df.empty:
...
if page == "schema":
    ...
    for indicator in section_indicators:
        with st.container(border=True):
            render_indicator(indicator, population_df, projection_df, unemployment_df, inactivity_df, migration_df, lang)
