...
UI = {
    "it": {
        ...
        "welcome_title": "Dati, territori e transizioni verso la vita adulta",
        "welcome_text": "Un prototipo avanzato e progressivamente aggiornabile per collegare ricerca, comunicazione pubblica e collaborazione con il territorio.",
        "welcome_scope": "Bergamo · Lombardia · Italia",
        "menu": "Menu",
        "go_to": "Vai a",
    ...
    "en": {
        ...
        "welcome_title": "Data, territories and transitions to adulthood",
        "welcome_text": "An advanced, progressively updatable prototype connecting research, public communication and territorial collaboration.",
        "welcome_scope": "Bergamo · Lombardy · Italy",
        "menu": "Menu",
        "go_to": "Go to",
...
INDICATORS = [
    ...
    },
    {
        ...
        "section_id": "projections",
        "indicator_it": "Variazione annua della popolazione in eta lavorativa",
    ...
    },
    {
        ...
        "section_id": "projections",
        "indicator_it": "Giovani e adulti prossimi all'uscita dall'eta lavorativa",
...
def render_welcome_page(lang):
    ...
    st.markdown(
        f"""
        <div style="text-align:center; max-width:900px; margin:1.2rem auto 0 auto;">
          ...
          <p style="font-size:1.05rem; font-weight:700; color:#0B78B7;">
            {text("welcome_scope", lang)}
          </p>
        </div>
        """,
