...
UI = {
    "it": {
        ...
        "bergamo_brescia": "Bergamo e Brescia",
    ...
    "en": {
        ...
        "bergamo_brescia": "Bergamo and Brescia",
...
def filter_real_data(df, ind, lang, territories):
    ...
    if ind["chart"] == "bes_best_indicator":
        ...
        domain_index = preferred_index(domains, "Istruzione e formazione")
        ...
        default_indicator = "Passaggio all'universita"
        ...
        scope = st.radio(
            ...
            [text("bergamo_brescia", lang), text("main_territories", lang), text("all_lombardy_territories", lang)],
            horizontal=True,
            key=f"real_{ind['indicator_id']}_scope",
        )
        if scope == text("bergamo_brescia", lang):
            df = df[df["territory"].isin(["Bergamo", "Brescia"])]
        elif scope == text("main_territories", lang):
...
def render_chart(df, ind, lang):
    ...
    value_domain = common_value_domain(df, symmetric=symmetric)
